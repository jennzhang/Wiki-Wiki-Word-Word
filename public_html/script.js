...
function getBackup()
{
	...
	if ( today.getDay() == 1 )	// Mondays
	{
		...
		termObj.url = "https://en.wikipedia.org/wiki/Mount_Eerie";
		termObj.image.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Phil_Elverum_%28Mount_Eerie%29.jpg/220px-Phil_Elverum_%28Mount_Eerie%29.jpg";
		termObj.image.alt = "Phil Elverum performing as Mount Eerie in March 2012";
	...
	else if( today.getDay() % 2 == 0 )	// Tuesdays, Thursdays, Saturdays
	{
		...
		termObj.url = "https://en.wikipedia.org/wiki/Red_lory";
		termObj.image.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Eos_bornea_-Taronga_Zoo%2C_Sydney%2C_Australia-8a_%281%29.jpg/220px-Eos_bornea_-Taronga_Zoo%2C_Sydney%2C_Australia-8a_%281%29.jpg";
		termObj.image.alt = "Red Lory";
	...
	else	// Wednesdays, Fridays, Sundays
	{
		...
		termObj.image.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/A_380_meeting.jpg/220px-A_380_meeting.jpg";
		termObj.image.alt = "The Airbus A380 is the largest passenger aircraft.";
